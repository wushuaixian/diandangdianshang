  ...
  <v-g-editor ref="flowChart" class="af-process-detail">
          ...
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24">
              <a-form-model-item label="状态">
                {{
                  $$(
                    ApprovalProcessStatusList.find((x) => x.value === $$(info, 'isAvailable')),
                    'label'
                  )
                }}
              </a-form-model-item>
    ...
    <div class="af-process-detail__container">
      <div class="af-process-detail__toolbar">
        <a-button :disabled="saveReadOnly" type="text" @click="handleSave">
          <img :src="saveImg" style="width: 15px; height: 15px; position: relative; top: 24px; margin-left: -10px" />
        </a-button>
        <flow-toolbar />
        <a-button type="text" @click="handleCheck">
          <img :src="checkImg" style="width: 15px; height: 17px; position: relative; top: -24px; left: 263px" />
        </a-button>
      </div>
