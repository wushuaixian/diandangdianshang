 ...
 * @LastEditTime: 2021-08-03 11:52:00
...
<template>
  <div>
    <header-title class="header-title"> <span>新增下级功能</span> </header-title>
    <a-form-model
      class="form"
      ref="ruleForm"
      :model="queryParams"
      ...
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="权限层级" prop="level">
            <!-- <a-input v-model="queryParams.name" /> -->
            <d-select v-model="queryParams.level" :options="levelList"></d-select>
          </a-form-model-item>
        </a-col>
        <a-col :span="12">
          <a-form-model-item label="权益类型" prop="type">
            <!-- <a-input v-model="queryParams.name" /> -->
            <d-select v-model="queryParams.type" :options="typeList"></d-select>
          </a-form-model-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="上级代码" prop="parentCode">
            <a-input v-model="queryParams.parentCode" />
          </a-form-model-item>
        </a-col>
        <a-col :span="12">
      ...
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="作用域" prop="domain">
            <a-input v-model="queryParams.domain" />
          </a-form-model-item>
        </a-col>
        <a-col :span="12">
          <a-form-model-item label="路径" prop="path">
            <a-input v-model="queryParams.path" />
          </a-form-model-item>
        </a-col>
      </a-row>
      ...
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="小图标" prop="icon">
            <a-input v-model="queryParams.icon" />
          </a-form-model-item>
        </a-col>
      </a-row>
      <a-row>
...
<script>
import { saveFunction } from '@/api/configgurationCenter/menuPathConfiguration'
export default {
  props: {
    info: {
      type: Object,
  ...
  methods: {
    async save() {
      ...
      console.log(this.info.platformId)
