...
<script>
import { getSourceList } from '@/api/projectCarry'
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        { title: '公司名称', dataIndex: 'enterpriseName', key: 'enterpriseName', width: 240 },
        ...
        { title: '寻源数量', dataIndex: 'searchNum', key: 'searchNum' },
      ...
      exportParams: {
        templateCode: 'findSourceListExport',
        jsonTxt: {},
        exportType: 'exportFindSourceList',
        fileName: '采购计划待执行列表'
      }
    }
  },
  methods: {
    ...
    async getList(params) {
      ...
      const result = await getSourceList(data)
