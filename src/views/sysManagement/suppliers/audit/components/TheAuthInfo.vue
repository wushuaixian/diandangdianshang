<template>
  <div class="mid" ref="container">
    <a-affix :offset-top="10" :target="() => this.$refs.container" :class="{ affix: scrollTop > 50 }">
      <header>
        <ul>
    ...
    <div class="header">
      <a-card :bordered="false" id="Factory">
        <header-title>
          <span>验厂信息</span>
        </header-title>
        <a-form :form="form">
      ...
      <a-card type="inner" :bordered="false" id="BusinessInfo">
        <header-title>
          <span>工商信息</span>
        </header-title>
      ...
      <a-card type="inner" :bordered="false" id="Review">
        <header-title>
          <span>综合评审情况</span>
        </header-title>
        <s-table ref="table" name="TheAuthInfoTable1" :data="init" :columns="goodsColumns"> </s-table>
      </a-card>
      <a-card type="inner" :bordered="false" id="AuditClause">
        <header-title>
          <span>审核条款</span>
        </header-title>
        <div class="p-l20">
      ...
      <a-card type="inner" :bordered="false" id="Qualification">
        <header-title>
          <span>企业基本资质</span>
        </header-title>
        <a-form :form="form">
      ...
      <a-card type="inner" :bordered="false" id="Files">
        <header-title>
          <span>资质附件</span>
        </header-title>
